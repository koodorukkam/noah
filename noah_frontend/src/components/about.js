    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-8 mx-auto text-center">
          ...
          We believe in the power of what people can achieve when they come together. We are joined by many like minded organisations like ……, all with one purpose - to come together and help. 
          </p>
